...
Version  : 6.3.1
Release  : 112
URL      : https://download.kde.org/stable/plasma/6.3.1/kactivitymanagerd-6.3.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.1/kactivitymanagerd-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/kactivitymanagerd-6.3.1.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.3.1
cd %{_builddir}/kactivitymanagerd-6.3.1
pushd ..
cp -a kactivitymanagerd-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739906468
mkdir -p clr-build
pushd clr-build
