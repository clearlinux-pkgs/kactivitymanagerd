...
Version  : 6.1.5
Release  : 105
URL      : https://download.kde.org/stable/plasma/6.1.5/kactivitymanagerd-6.1.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.5/kactivitymanagerd-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/kactivitymanagerd-6.1.5.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.1.5
cd %{_builddir}/kactivitymanagerd-6.1.5
pushd ..
cp -a kactivitymanagerd-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725994718
mkdir -p clr-build
pushd clr-build
