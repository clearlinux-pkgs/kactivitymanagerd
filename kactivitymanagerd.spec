...
Version  : 5.27.1
Release  : 76
URL      : https://download.kde.org/stable/plasma/5.27.1/kactivitymanagerd-5.27.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.1/kactivitymanagerd-5.27.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.1/kactivitymanagerd-5.27.1.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.27.1
cd %{_builddir}/kactivitymanagerd-5.27.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677190055
mkdir -p clr-build
pushd clr-build
