...
Source0  : https://download.kde.org/stable/plasma/5.26.2/kactivitymanagerd-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/kactivitymanagerd-5.26.2.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.26.2
cd %{_builddir}/kactivitymanagerd-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667246003
mkdir -p clr-build
pushd clr-build
