...
Version  : 5.16.2
Release  : 19
URL      : https://download.kde.org/stable/plasma/5.16.2/kactivitymanagerd-5.16.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.2/kactivitymanagerd-5.16.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.2/kactivitymanagerd-5.16.2.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.16.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1561479671
mkdir -p clr-build
pushd clr-build
