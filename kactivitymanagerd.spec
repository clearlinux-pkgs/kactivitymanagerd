...
Source0  : https://download.kde.org/stable/plasma/5.14.3/kactivitymanagerd-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/kactivitymanagerd-5.14.3.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.14.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1541530642
mkdir -p clr-build
pushd clr-build
%cmake ..
