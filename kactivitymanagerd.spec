...
Source0  : https://download.kde.org/stable/plasma/5.17.2/kactivitymanagerd-5.17.2.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.17.2/kactivitymanagerd-5.17.2.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.17.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572437630
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kactivitymanagerd-5.17.2/COPYING.GPL2 %{buildroot}/usr/share/package-licenses/kactivitymanagerd/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/kactivitymanagerd-5.17.2/COPYING.GPL3 %{buildroot}/usr/share/package-licenses/kactivitymanagerd/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd clr-build
%make_install
popd
