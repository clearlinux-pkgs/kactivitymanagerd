...
Source0  : https://download.kde.org/stable/plasma/6.2.0/kactivitymanagerd-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/kactivitymanagerd-6.2.0.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.2.0
cd %{_builddir}/kactivitymanagerd-6.2.0
pushd ..
cp -a kactivitymanagerd-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728625473
mkdir -p clr-build
pushd clr-build
