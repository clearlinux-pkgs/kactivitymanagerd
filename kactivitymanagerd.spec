...
Version  : 5.14.0
Release  : 3
URL      : https://download.kde.org/stable/plasma/5.14.0/kactivitymanagerd-5.14.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.0/kactivitymanagerd-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/kactivitymanagerd-5.14.0.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.14.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1539109327
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
