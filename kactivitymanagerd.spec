...
Version  : 6.0.3
Release  : 95
URL      : https://download.kde.org/stable/plasma/6.0.3/kactivitymanagerd-6.0.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.3/kactivitymanagerd-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/kactivitymanagerd-6.0.3.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-6.0.3
cd %{_builddir}/kactivitymanagerd-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711664156
mkdir -p clr-build
pushd clr-build
