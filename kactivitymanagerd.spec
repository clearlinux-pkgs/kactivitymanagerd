...
Source0  : https://download.kde.org/stable/plasma/5.23.4/kactivitymanagerd-5.23.4.tar.xz
...
%prep
%setup -q -n kactivitymanagerd-5.23.4
cd %{_builddir}/kactivitymanagerd-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638359412
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kactivitymanagerd-5.23.4/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kactivitymanagerd/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
