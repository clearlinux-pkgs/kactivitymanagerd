...
Version  : 6.1.2
Release  : 101
URL      : https://download.kde.org/stable/plasma/6.1.2/kactivitymanagerd-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/kactivitymanagerd-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/kactivitymanagerd-6.1.2.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.1.2
cd %{_builddir}/kactivitymanagerd-6.1.2
pushd ..
cp -a kactivitymanagerd-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720602358
mkdir -p clr-build
pushd clr-build
