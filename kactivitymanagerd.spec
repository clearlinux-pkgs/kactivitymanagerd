...
Version  : 5.27.7
Release  : 83
URL      : https://download.kde.org/stable/plasma/5.27.7/kactivitymanagerd-5.27.7.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.7/kactivitymanagerd-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/kactivitymanagerd-5.27.7.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.27.7
cd %{_builddir}/kactivitymanagerd-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690899314
mkdir -p clr-build
pushd clr-build
