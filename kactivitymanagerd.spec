...
Source0  : https://download.kde.org/stable/plasma/6.2.4/kactivitymanagerd-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/kactivitymanagerd-6.2.4.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.2.4
cd %{_builddir}/kactivitymanagerd-6.2.4
pushd ..
cp -a kactivitymanagerd-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735264381
mkdir -p clr-build
pushd clr-build
