...
Version  : 5.27.2
Release  : 77
URL      : https://download.kde.org/stable/plasma/5.27.2/kactivitymanagerd-5.27.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.2/kactivitymanagerd-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/kactivitymanagerd-5.27.2.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.27.2
cd %{_builddir}/kactivitymanagerd-5.27.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677605092
mkdir -p clr-build
pushd clr-build
