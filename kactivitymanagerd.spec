...
Version  : 5.27.9
Release  : 85
URL      : https://download.kde.org/stable/plasma/5.27.9/kactivitymanagerd-5.27.9.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.9/kactivitymanagerd-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/kactivitymanagerd-5.27.9.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.27.9
cd %{_builddir}/kactivitymanagerd-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698287107
mkdir -p clr-build
pushd clr-build
