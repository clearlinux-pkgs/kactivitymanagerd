...
Version  : 6.0.4
Release  : 96
URL      : https://download.kde.org/stable/plasma/6.0.4/kactivitymanagerd-6.0.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.4/kactivitymanagerd-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kactivitymanagerd-6.0.4.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.0.4
cd %{_builddir}/kactivitymanagerd-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713295059
mkdir -p clr-build
pushd clr-build
