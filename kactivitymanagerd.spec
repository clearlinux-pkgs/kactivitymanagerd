...
Source0  : https://download.kde.org/stable/plasma/5.27.8/kactivitymanagerd-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/kactivitymanagerd-5.27.8.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.27.8
cd %{_builddir}/kactivitymanagerd-5.27.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694545880
mkdir -p clr-build
pushd clr-build
