...
Version  : 6.1.4
Release  : 104
URL      : https://download.kde.org/stable/plasma/6.1.4/kactivitymanagerd-6.1.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.4/kactivitymanagerd-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/kactivitymanagerd-6.1.4.tar.xz.sig
...
%setup -q -n kactivitymanagerd-6.1.4
cd %{_builddir}/kactivitymanagerd-6.1.4
pushd ..
cp -a kactivitymanagerd-6.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723140252
mkdir -p clr-build
pushd clr-build
