...
Version  : 5.27.6
Release  : 82
URL      : https://download.kde.org/stable/plasma/5.27.6/kactivitymanagerd-5.27.6.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.6/kactivitymanagerd-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/kactivitymanagerd-5.27.6.tar.xz.sig
...
%prep
%setup -q -n kactivitymanagerd-5.27.6
cd %{_builddir}/kactivitymanagerd-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687289833
mkdir -p clr-build
pushd clr-build
